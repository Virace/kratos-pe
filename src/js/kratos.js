    ...
    const highlightConfig = function (flag) {
        ...
        if ($('pre code').length >= 1) {
            if (typeof hljs == 'undefined') {
                const assetsPath = kratos.directory;
                $('head').append('<link href="' + assetsPath + '/assets/css/highlight/style.min.css" rel="stylesheet" type="text/css" />')

                let JSDependencies = [assetsPath + '/assets/js/highlight/highlight.pack.js',
                    assetsPath + '/assets/js/highlight/highlightjs-copy-button.min.js',
                    assetsPath + '/assets/js/highlight/highlightjs-line-numbers.min.js'];
